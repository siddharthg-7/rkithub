...
export const PlacementSuccess = () => {
  const companies = [
    ...
    { name: 'Tech Mahindra',src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/HCL_Technologies_logo.svg/1920px-HCL_Technologies_logo.svg.png?_=20100214041014' },
  ];
