...
export const PlacementSuccess = () => {
  const companies = [
    ...
    { name: 'Cognizant', src: 'https://upload.wikimedia.org/wikipedia/commons/4/43/Cognizant_logo_2022.svg' },
    { name: 'Capgemini', src: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Capgemini_201x_logo.svg' },
    { name: 'HCL', src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/HCL_Technologies_logo.svg/1920px-HCL_Technologies_logo.svg.png?_=20100214041014' },
    { name: 'Tech Mahindra', src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Tech_Mahindra_New_Logo.svg/1280px-Tech_Mahindra_New_Logo.svg.png?_=20130808140256' },
  ];
  ...
  return (
    <div id="placements" className="flex flex-col h-full pl-0 lg:pl-12 lg:border-l lg:border-gray-100 mt-16 lg:mt-0">
      ...
      {/* Placement Cards Grid with Arrows */}
      <div className="relative w-full">
        <button className="hidden sm:flex absolute -left-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-white border border-gray-200 rounded-full items-center justify-center text-gray-500 shadow-md hover:text-[#0B4F9C] hover:border-[#0B4F9C] z-10 transition-colors">
          <ChevronLeft className="w-4 h-4" />
        </button>
        
        <button className="hidden sm:flex absolute -right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-white border border-gray-200 rounded-full items-center justify-center text-gray-500 shadow-md hover:text-[#0B4F9C] hover:border-[#0B4F9C] z-10 transition-colors">
          <ChevronRight className="w-4 h-4" />
        </button>
          ...
          {placements.map((student, i) => (
            ...
            >
              <img 
                src={student.image} 
                alt={student.name} 
                className="w-16 h-16 rounded-full object-cover mb-3 border-2 border-gray-50"
              />
              <h3 className="text-[14px] font-[800] text-[#0F172A] leading-tight mb-1">{student.name}</h3>
              <p className="text-[#64748B] text-[11px] font-[600] mb-3">{student.course}</p>
