      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <motion.div 
            ...
            className="bg-[#FAFAFA] border border-gray-200 rounded-xl p-8 flex flex-col justify-center space-y-10"
          >
          ...
          <motion.div 
            ...
            className="rounded-xl overflow-hidden shadow-sm border border-gray-200 min-h-[300px] lg:min-h-full"
          >
            <iframe 
