  ...
  return (
    <nav className="fixed top-5 left-1/2 -translate-x-1/2 z-50 bg-white/70 backdrop-blur-xl border border-slate-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-full px-6 py-3.5 w-[92%] max-w-5xl flex justify-between items-center transition-all">
      ...
      <div className="flex items-center gap-5">
        <Link to="/login" className="text-[14px] font-semibold text-slate-600 hover:text-slate-900 transition-colors">
          Login
        </Link>
        <Link to="/signup" className="text-[14px] font-bold bg-slate-900 text-white px-5 py-2.5 rounded-full hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/10 hover:shadow-xl hover:shadow-slate-900/20 active:scale-95">
          Get Started
        </Link>
      </div>
    </nav>
