      ...
      <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl mb-12 max-w-xl mx-auto leading-relaxed">
            Modern front-end testing for the modern web. Learn Cypress to write fast, easy, and reliable testing for anything that runs in a browser.
          </p>
